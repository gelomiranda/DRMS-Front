...
// Patients
const PatientCreate = () => import('@/views/patients/Create')
const PatientUpdate = () => import('@/views/patients/Update')
...
// Treatments
const TreatmentCreate = () => import('@/views/treatments/Create')
